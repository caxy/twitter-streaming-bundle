...
use Bangpound\Bundle\TwitterStreamingBundle\Entity\Follow;
use Bangpound\Bundle\TwitterStreamingBundle\Form\FollowType;
...
class FollowController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BangpoundTwitterStreamingBundle:Follow')->findAll();
     ...
     *
     * @Route("/", name="follow_create")
     * @Method("POST")
     * @Template("BangpoundTwitterStreamingBundle:Follow:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BangpoundTwitterStreamingBundle:Follow')->find($id);
     ...
     *
     * @Route("/{id}/edit", name="follow_edit")
     * @Method("GET")
     * @Template()
     */
    ...
    */
     ...
     *
     * @Route("/{id}", name="follow_update")
     * @Method("PUT")
     * @Template("BangpoundTwitterStreamingBundle:Follow:edit.html.twig")
     */
